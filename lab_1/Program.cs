...
namespace ConsoleApplication1 
{
    class Program
    {
        public static void Main(string[] args)
        {
            ...
            { ("Your answer is not correct. Please, enter " + user + str_start[1] + 
admin + '.'),
            ("Your password is not correct.") };
            string[] str_disk_info = new string[3]
            { ("You access logical drives C and D as a "),
...
#pragma warning disable CS8600 // Преобразование литерала, допускающего значение
    //NULL или возможного значения NULL в тип, не допускающий значение NULL.
            ...
            else if (enter == admin)
            {
                ...
                string correct_password = "admin1234"; // пароль к аккаунту
                //администратора.
                string password = Convert.ToString(Console.ReadLine());
#pragma warning restore CS8600 // Преобразование литерала, допускающего значение
                //NULL или возможного значения NULL в тип, не допускающий значение NULL.
                if (password == correct_password)
                {
                    Console.WriteLine(str_hello + admin + '!');
                    Console.WriteLine(str_disk_info[0] + admin + n + 
str_disk_info[2]);
                }
